...
| --- | --- |
| `/dashboard` | Grille 12 colonnes sur desktop : évolution du capital, indicateurs, quota, objectifs, bankrolls et paris récents sont répartis sans inventer de données. Sans bankroll, le parcours de démarrage utilise une largeur contrôlée et un indicateur de progression desktop. |

...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "marketing.meta.legal" });
  return marketingMetadata({ locale, path: "/legal-notice", title: t("title"), description: t("description") });
}

...
Règles impératives :
- "date" : utilise exclusivement la date de PRISE DU PARI, jamais la date ou l'heure de l'événement. Elle peut être en bas du ticket ("10h02 - 22 juin 2026" → "2026-06-22") ou dans l'en-tête, près de la référence du pari ("14 Sept. 2026 • 18:32" → "2026-09-14"). Sur un ticket PMU, la date "17 sept. 2026, 21:00" dans la carte de sélection est celle du MATCH et ne doit jamais remplir "date". Si la date complète de prise de pari n'est pas visible, mets null : ne complète jamais avec la date actuelle ou celle du match.
...
- Lis d'abord le STATUT DU TICKET dans son en-tête, près du type de pari et de la cote. Sur PMU, "Simple @ 2,63 • Gagné" impose "result": "Gagné", même si la ligne de sélection affiche seulement "Sélection gagnante : 2" ; "Simple @ 2,63 • En cours" impose "result": "En attente", même si un bouton "Cash Out" ou un "Gain potentiel" est visible. Ne déduis jamais le résultat depuis la date du match ou un chiffre de sélection. Relis l'en-tête avant de conclure "En attente".

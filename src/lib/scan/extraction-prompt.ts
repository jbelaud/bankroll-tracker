...
- CONTRÔLE FINAL OBLIGATOIRE avant chaque objet JSON : choisis ensuite "betType" exclusivement dans la liste rattachée à CE sport dans la taxonomie ci-dessus. Ne mélange jamais deux listes : "Buteur", "Passeur décisif", "But sur penalty" et "Score exact" sont du Football, jamais du Cyclisme ; "Top 1", "Top 3", "Top 10", "Vainqueur d'étape" et "Classement général" sont du Cyclisme, jamais du Football. Si le sport est évident mais que le marché ne figure pas dans sa liste, conserve ce sport et utilise "Autre" ; ne change jamais le sport juste pour faire correspondre un type de pari.

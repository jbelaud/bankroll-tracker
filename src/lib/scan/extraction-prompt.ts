...
- "Cashé" (encaissement anticipé) : utilise ce résultat UNIQUEMENT si le ticket déjà clôturé affiche explicitement le statut "Cashé" / "Cash Out effectué", avec le montant réellement encaissé dans "Gains". Un bouton ou une offre "Cashout 0,70 €" visible sur un ticket "En cours" signifie seulement que le cashout est proposé : le pari n'est PAS cashé, garde "result": "En attente" et "cashOutAmount": null. Ne déduis jamais un cashout depuis une offre disponible ou un bouton d'action.

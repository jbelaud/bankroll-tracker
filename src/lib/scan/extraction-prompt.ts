...
- "sport" : déduis-le d'abord de la compétition, des participants et du contexte de l'événement. Le type de pari ne suffit jamais à lui seul, mais il peut corroborer des participants ou une compétition déjà visibles. N'utilise jamais la cote ou le nom d'une promotion comme indice sportif. Une promotion bookmaker n'est jamais une information sportive. Exemples : Afrique du Sud - Canada en rugby doit avoir "sport": "Rugby", même avec un badge « La Grosse Cote Boostée » ; un coureur, une étape ou un classement cycliste doit avoir "sport": "Cyclisme".
- Sur PMU, une opposition entre deux ÉQUIPES NATIONALES désignées par leurs pays avec le marché « Vainqueur avec set(s) de handicap » est un indice fort de Volleyball. Exemple validé : « Suisse - Roumanie » avec « Suisse -1,5 » doit donner "sport": "Volleyball" et "betType": "Handicap", jamais Tennis. Cette règle exige des équipes nationales : ne l'applique pas à une opposition de joueurs et ne remplace jamais une mention visible explicite de Tennis, Tennis de table, Badminton ou Padel.

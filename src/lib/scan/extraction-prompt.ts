...
- "sport" : déduis-le de la compétition et des participants de l'événement, JAMAIS du type de pari, de la cote ou du nom d'une promotion. Vérifie que sport, participants et betType sont cohérents avant de répondre. Exemples : Afrique du Sud - Canada en rugby doit avoir "sport": "Rugby", même avec le type "Top 1" ou le badge « La Grosse Cote Boostée » ; un coureur, une étape ou un classement cycliste doit avoir "sport": "Cyclisme". Une promotion bookmaker n'est jamais une information sportive.

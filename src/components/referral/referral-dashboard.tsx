...
export function ReferralDashboard({
  ...
  const copyLink = () => copyText(referralLink);
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-5 pb-4">
      <section className="glass-card overflow-hidden rounded-2xl p-5 sm:p-7">
        ...
        {!paused && (
          <>
            <div className="mt-5 rounded-2xl border border-border bg-background/35 p-3 sm:p-4">
              ...
              <div className="mt-2 flex flex-col gap-2 sm:flex-row">
                ...
                <Button variant="outline" onClick={nativeShare} className="min-h-touch rounded-xl px-4 text-sm font-semibold">{t("shareNative")}</Button>
              </div>

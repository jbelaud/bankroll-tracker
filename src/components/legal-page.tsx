...
const copy: Record<LegalKind, Record<"fr" | "en", { title: string; intro: string; sections: Section[] }>> = {
  privacy: {
    fr: {
      ...
      intro: "Cette page explique simplement quelles données Kalivoa utilise pour fournir le suivi de bankroll.",
      sections: [
        { title: "Données utilisées", paragraphs: ["Nous traitons les données de compte, tes bankrolls, tes paris, tes préférences et les retours que tu nous envoies.", "Les captures de tickets sont transmises au fournisseur IA choisi pour extraire les paris. Kalivoa ne les conserve pas après l’analyse."] },
        { title: "Pourquoi", paragraphs: ["Ces données servent à authentifier ton compte, afficher tes statistiques, analyser tes captures, appliquer tes limites de scans et assurer le support.", "Les paiements sont traités par Stripe. Kalivoa ne reçoit ni ne stocke ton numéro de carte bancaire."] },
    ...
    en: {
      title: "Privacy",
      intro: "This page plainly explains which data Kalivoa uses to provide bankroll tracking.",
      sections: [
        { title: "Data we use", paragraphs: ["We process account data, bankrolls, bets, preferences and the feedback you send us.", "Ticket screenshots are sent to the selected AI provider to extract bets. Kalivoa does not retain them after analysis."] },
        { title: "Why", paragraphs: ["This data authenticates your account, displays statistics, analyzes screenshots, applies scan limits and provides support.", "Payments are processed by Stripe. Kalivoa never receives or stores your card number."] },
  ...
  terms: {
    fr: {
      ...
      intro: "Kalivoa est un outil personnel de suivi et d’analyse de paris sportifs.",
      sections: [
        { title: "Ce que fait Kalivoa", paragraphs: ["Le service aide à saisir, organiser et visualiser tes paris. Les extractions par IA doivent toujours être vérifiées avant import.", "Kalivoa ne fournit aucun conseil de pari, aucune promesse de gain et ne transmet pas de paris à un bookmaker."] },
    ...
    en: {
      title: "Terms of use",
      intro: "Kalivoa is a personal tool for tracking and analyzing sports bets.",
      sections: [
        { title: "What Kalivoa does", paragraphs: ["The service helps you enter, organize and view your bets. AI extractions must always be checked before importing.", "Kalivoa does not provide betting advice, promise gains, or place bets with bookmakers."] },
  ...
  responsible: {
    fr: {
      ...
      sections: [
        { title: "Garde des limites", paragraphs: ["Définis un budget dédié, fixe une limite de perte mensuelle dans Kalivoa et respecte-la. Une série de pertes ne doit jamais être compensée par une mise plus importante."] },
    ...
    en: {
      ...
      sections: [
        { title: "Keep limits", paragraphs: ["Set a dedicated budget, create a monthly loss limit in Kalivoa and stick to it. A losing streak should never be chased with a larger stake."] },
